...
`routes_stats`, `routes_pricing` here, more added by later tasks) are imported and included
...
from . import routes_pricing, routes_requests, routes_stats, routes_status
